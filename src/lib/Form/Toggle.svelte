...
<div class="flex items-start gap-2">
	<input
		...
		on:mouseleave
		on:paste
		class='h-5 w-9 border-0 bg-gray-300 dark:bg-gray-600 checked:bg-brand dark:checked:bg-brand appearance-none relative flex items-center px-1 transition-all ease-in-out duration-300 text-brand focus:!ring-gray-500 checked:focus:!ring-brand mt-[6px]'
